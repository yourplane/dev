...
echo "  Restart:      systemctl --user restart dev-daemon.service"
  echo "  Or restart:   $REPO_ROOT/dev-daemon/restart.sh"
  echo "  Deploy:       $REPO_ROOT/dev-daemon/deploy.sh [branch] [source-repo]"
